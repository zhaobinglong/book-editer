(function() {
    ...
    ;Colorpicker.prototype = {
        init(opt) {
            ...
            this.elem_hexInput = null;
            this.elem_showColor = null;
            this.elem_showModeBtn = null;
            ...
            var div = document.getElementById("color-render-box");
        ...
        render: function() {
            var tpl = `
				<div style="position: inherit;z-index: 100;display: flex; border: 1px solid #EFEFEF">
					<div style='width:0;height:0;padding:0px;background: #f9f9f9;display: flex;flex-flow: row wrap;align-content: space-around;justify-content: space-around;' class='color-palette'>
